...
//                Log.i("Music Album",musicAlbum+"");
                if (getAlbumPicture(musicAlbum,musicUrl)!=null){
                    music.setAlbumPicture(getAlbumPicture(musicAlbum,musicUrl));
//                    Log.i("Music Album",musicAlbum+"....................");
                }
                musicList.add(music);
            }
...
/*    public static List<HashMap<String,String>> getMusicMaps(List<Music> musiclist){
    ...
    * */
//  获取专辑图(内存优化)
    public static Bitmap getAlbumPicture(String musicAlbum,String path){
        MediaMetadataRetriever retriever=new MediaMetadataRetriever();
        retriever.setDataSource(path);
        byte[] picture=retriever.getEmbeddedPicture();
        if (musicAlbum!=null){
