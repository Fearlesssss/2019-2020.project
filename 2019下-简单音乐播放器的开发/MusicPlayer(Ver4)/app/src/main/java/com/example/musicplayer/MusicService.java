...
//    private List<HashMap<String,String>> getMusicMaps=new ArrayList<HashMap<String, String>>();
    private Music music;
    ...
    class myBinder extends Binder{
        public MusicService getService(){
            Log.i("musicService","get MusicService.....");
...
/*
    public List<HashMap<String, String>> getGetMusicMaps() {
        return getMusicMaps;
    }
    public void setGetMusicMaps(List<HashMap<String, String>> getMusicMaps) {
        this.getMusicMaps = getMusicMaps;
    }
*/
    ...
    public void play(final int position){
        ...
        Log.i("Playing",musicList.get(position)+" ........ ");
    }
    ...
    public void SelfPlay(){
     //   progress=selfp;
        this.position=position;
        playMusic();
//        mediaPlayer.setLooping(true);//自循
    }//单曲循环
    public void next(){
        switch (i){
            case 1:
